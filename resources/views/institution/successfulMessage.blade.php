...
<div class="container">
    <div class="row justify-content-center">
            ...
            <head>
                ...
                <link rel="stylesheet" href="{{ asset('CSS/successfulMessage.css') }}">
            ...
            <body>
              ...
              <div id='card' class="animated fadeIn">
                <div id='upper-side'>
                    ...
                    <div id='lower-side'>
                        <p class='message'> Congratulations, your account has been successfully created. </p>
                        <p class='message'>You will also receive another email when your registration is approved</p>
                        <a href="{{('/institution')}}" id="contBtn">Continue</a>
                    </div>
                </div>
