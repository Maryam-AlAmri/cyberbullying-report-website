                ...
                <div class="col-lg-3">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <p class="explain" style="margin-bottom: 15%; margin-top: 5%">Register your clinic</p>
                            <a  href="{{ ('/consultants-register') }}" ><p><button class="button"><span>Register</span></button></p></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <p class="explain" style="margin-bottom: 15%; margin-top: 5%">View All Victims Details</p>
                            <form action="/consultant/request/list" method="post">
                                @csrf
                ...
                <div class="col-lg-3">
                    <div class="col-lg-12">
                       <div class="card">
                           ...
                           <p class="explain" style="margin-bottom: 15%; margin-top: 5%">Chatting with your Victims </p>
                           <p><button class="button"><span>Chat</span></button></p>
                       </div>
                   </div>
               </div>
               ...
               <div class="col-lg-3">
                <div class="col-lg-12">
                   <div class="card">
                       ...
                       <h1 class="title">Services</h1><hr>
                       <p class="explain" style="margin-bottom: 15%; margin-top: 5%">Add and update your services</p>
