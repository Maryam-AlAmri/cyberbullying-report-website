                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="type"  id="type" class="form-control @error('type') is-invalid @enderror">
                                    {{-- <option value="admin" value="{{ old('type') }}" required>Admin</option> --}}
                                    <option value="institution" value="{{ old('type') }}" required>Institution</option>
                                    <option value="consultant" value="{{ old('type') }}" required>Consultant</option>
                                    <option value="victim" value="{{ old('type') }}" required>Victim</option>
                                  </select>
